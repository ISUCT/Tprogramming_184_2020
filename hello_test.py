...
class TestSum(unittest.TestCase):
    ...
    def test_3_3_calc(self):
        res = hello.calc(3, 3)
        self.assertAlmostEqual(res, 6562.097, places=3,
                               msg='Should be 6562.097')

    def test_3_4_calc(self):
        res = hello.calc(3, 4)
        self.assertAlmostEqual(res, 14348908.290, places=3,
                               msg='Should be 14348908.290')

    def test_4_3_calc(self):
        res = hello.calc(4, 3)
        self.assertAlmostEqual(res, 65537.097, places=3,
                               msg='Should be 65537.097')

    def test_4_4_calc(self):
        res = hello.calc(4, 4)
        self.assertAlmostEqual(res, 1073741825.290,
                               places=3, msg='Should be 1073741825.290')
